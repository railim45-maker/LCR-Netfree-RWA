    ...
    <div className="min-h-screen bg-background text-foreground space-y-12 pb-28 pt-24 px-6 max-w-5xl mx-auto">
      ...
      <div className="space-y-4 text-center">
        ...
        <p className="max-w-2xl mx-auto text-muted-foreground leading-relaxed text-sm md:text-base">
          La rigenerazione della terra passa attraverso il ripristino dell'equilibrio biologico del suolo. L'utilizzo di tecnologie naturali e microorganismi effettivi rappresenta uno strumento essenziale per la permacultura e la vita comunitaria.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-6 max-w-xl mx-auto">
          <Card className="border-border bg-card/40 backdrop-blur-md rounded-2xl p-6 space-y-4 flex flex-col justify-between hover:border-primary/50 transition-all">
            <div className="space-y-2">
              <span className="text-xs font-mono text-primary uppercase">Portale Applicativo</span>
              <h4 className="text-lg font-bold">Ecopassaparola - Microorganismi Effettivi</h4>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Approfondimenti pratici sull'utilizzo dei microorganismi per l'agricoltura sinergica e la bonifica biologica.
              </p>
            </div>
            <a href="https://www.ecopassaparola.net/it/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-xs font-semibold text-primary hover:underline pt-2">
