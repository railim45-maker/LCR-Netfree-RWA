      ...
      <main className="container max-w-5xl mx-auto px-4 md:px-6 space-y-12 md:space-y-20 relative z-10">
        ...
        <div className="text-center space-y-4 md:space-y-6 pt-4 md:pt-6 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 md:px-5 py-1.5 md:py-2 rounded-full bg-amber-50/70 border border-amber-200/70 text-amber-900 text-[11px] md:text-xs font-medium tracking-wide md:tracking-widest shadow-sm font-serif">
            <Sparkles className="w-3.5 h-3.5 text-amber-600 flex-shrink-0" /> L'Economia del Dono e la Moltiplicazione del Valore
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-stretch">
          ...
          <div className="p-6 sm:p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] bg-[#1c1917] text-stone-100 shadow-2xl space-y-6 border border-stone-800 relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <h3 className="text-xl md:text-3xl font-bold font-serif text-white">Il Problema Moderno</h3>
              <ul className="space-y-3.5 text-xs sm:text-sm text-stone-300 font-light leading-relaxed">
          ...
          <div className="p-6 sm:p-8 md:p-10 rounded-3xl md:rounded-[2.5rem] bg-white text-stone-800 shadow-xl space-y-6 border border-amber-200/50 relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <h3 className="text-xl md:text-3xl font-bold font-serif text-stone-900">Il Bisogno Umano</h3>
              <ul className="space-y-3.5 text-xs sm:text-sm text-stone-600 font-light leading-relaxed">
                <li className="flex items-start gap-3">
        ...
        {/* DASHBOARD INTERATTIVA (REATTORE RADIALE) */}
        <div className="rounded-3xl md:rounded-[2.5rem] border border-stone-800 bg-[#141210] p-6 sm:p-8 md:p-12 text-stone-100 shadow-2xl space-y-8 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch pt-2">
            ...
            {/* ALBERO A PIANI */}
            <div className="lg:col-span-6 bg-stone-900/60 border border-stone-800/80 rounded-2xl p-4 sm:p-5 backdrop-blur-md flex flex-col justify-between space-y-3">
                    ...
                    >
                      <div className="flex justify-between items-center gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`font-bold ${isFocused ? 'text-white' : 'text-stone-300'} text-xs font-serif truncate max-w-[130px] sm:max-w-none`}>
                            {lvl.label} ➔ <span className="text-amber-400">{lvl.peopleCount}</span>
                          </span>
                        </div>
                        <span className={`text-[10px] px-2 py-0.5 rounded whitespace-nowrap ${isCompleted ? 'bg-amber-950 text-amber-300 border border-amber-500/30' : 'bg-stone-900 text-stone-400'}`}>
                          {lvl.currentSteps}/{lvl.maxSteps}
                        </span>
                      </div>
                      <p className="text-[10px] text-stone-400 font-light pl-6 font-serif">{lvl.desc}</p>
                    </div>
                  );
                })}
              </div>
        ...
        <div className="p-8 sm:p-12 rounded-3xl md:rounded-[2.5rem] border border-amber-200/80 bg-gradient-to-br from-amber-50/70 via-white to-emerald-50/40 space-y-6 text-center shadow-xl backdrop-blur-md">
